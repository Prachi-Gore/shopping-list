const Footer=()=>{
    const keyPoints=['ContextApi','Bootstrap','React','typescript','useReducer',
    'notification','react-toast','useForm','html','animation']
    return(
        <footer className="fixed-bottom text-white moving-text d-flex gap-4 bg-green-600 px-2 py-1.5">
            {
